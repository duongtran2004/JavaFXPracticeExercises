...
public class RandomNumberGeneratorApplication extends Application { //every JavaFX Application must extend the Application Class
    @Override
    public void start(Stage primaryStage) throws Exception {
        //add a control (control in this case is a button)
        Button button1 = new Button("Click Me To Generate A Random Number");
        ...
        button1.setOnAction(event -> {
            ...
            showAlert("Button Clicked", "Number generated :" + generateRandomInteger());
