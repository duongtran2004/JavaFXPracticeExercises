...
public class TwoButtonsApplication extends Application { //every JavaFX Application must extend the Application Class
    @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        rootLayout.getChildren().addAll(button1, button2);
        ...
        button1.setOnAction(event -> {
            ...
            showAlert("Button 1 Clicked", "You clicked the First button!");
        ...
        button2.setOnAction(event -> {
            // You can choose to either display an alert:
            showAlert("Button 2 Clicked", "You clicked the Second button!");
